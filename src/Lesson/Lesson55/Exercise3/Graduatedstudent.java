...
public class Graduatedstudent extends Student {
    ...
    public Graduatedstudent(String id, String fullName, String address, Date birthDay
            , String email, String number, String studentId, String schoolName,
                            ...
                            float startingSalary, String compayName, String role) {
        super(id, fullName, address, birthDay, email, number, studentId, schoolName, className, major, avgGarde);
        this.graduatedYear = graduatedYear;
        this.creditRetake = creditRetake;
        this.failed = failed;
        this.startingSalary = startingSalary;
